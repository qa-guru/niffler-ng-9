...
public class UsersQueueExtension implements BeforeEachCallback,
    ...
    static{
        EMPTY_USERS.add(new StaticUser("test2", "secret", true));
        NOT_EMPTY_USERS.add(new StaticUser("test1", "secret", false));
        NOT_EMPTY_USERS.add(new StaticUser("test3", "secret", false));
    }
